...
| sp | [브라우저를 이해한다 2부 — 네트워크, HTTP, 캐시, OOP 원칙](./sp-browser-2.md) | `network`, `http`, `cache`, `oop` | 2026-03-31 |
| sp | [세션 기록 — 2026-03-31](./sp-session-20260331.md) | `session-log` | 2026-03-31 |
